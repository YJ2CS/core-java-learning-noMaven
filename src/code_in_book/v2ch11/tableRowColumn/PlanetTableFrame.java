...
public class PlanetTableFrame extends JFrame {
    ...
    private final HashSet<Integer> removedRowIndices;
    private final ArrayList<TableColumn> removedColumns;
    private final JCheckBoxMenuItem rowsItem;
    private final JCheckBoxMenuItem columnsItem;
    private final JCheckBoxMenuItem cellsItem;
    
    private final String[] columnNames = {"Planet", "Radius", "Moons", "Gaseous", "Color", "Image"};
