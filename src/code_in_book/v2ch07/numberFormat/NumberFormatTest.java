...
class NumberFormatFrame extends JFrame {
    ...
    private final JRadioButton numberRadioButton = new JRadioButton("Number");
    private final JRadioButton currencyRadioButton = new JRadioButton("Currency");
    private final JRadioButton percentRadioButton = new JRadioButton("Percent");
