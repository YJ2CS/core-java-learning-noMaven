...
class CollationFrame extends JFrame {
    ...
    private final JTextField newWord = new JTextField(20);
    private final JTextArea sortedWords = new JTextArea(20, 20);
    private final JButton addButton = new JButton("Add");
    private final EnumCombo<Integer> strengthCombo = new EnumCombo<>(Collator.class, "Primary",
            "Secondary", "Tertiary", "Identical");
    private final EnumCombo<Integer> decompositionCombo = new EnumCombo<>(Collator.class,
