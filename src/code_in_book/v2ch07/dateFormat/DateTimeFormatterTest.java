...
class DateTimeFormatterFrame extends JFrame {
    ...
    private final JComboBox<String> localeCombo = new JComboBox<>();
    private final JButton dateParseButton = new JButton("Parse");
    private final JButton timeParseButton = new JButton("Parse");
    private final JButton dateTimeParseButton = new JButton("Parse");
    private final JTextField dateText = new JTextField(30);
    private final JTextField timeText = new JTextField(30);
    private final JTextField dateTimeText = new JTextField(30);
    private final EnumCombo<FormatStyle> dateStyleCombo = new EnumCombo<>(FormatStyle.class,
            "Short", "Medium", "Long", "Full");
    private final EnumCombo<FormatStyle> timeStyleCombo = new EnumCombo<>(FormatStyle.class,
            "Short", "Medium");
    private final EnumCombo<FormatStyle> dateTimeStyleCombo = new EnumCombo<>(FormatStyle.class,
            "Short", "Medium", "Long", "Full");
