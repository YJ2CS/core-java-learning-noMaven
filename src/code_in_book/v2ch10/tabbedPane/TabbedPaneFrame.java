...
public class TabbedPaneFrame extends JFrame {
    ...
    public TabbedPaneFrame() {
        ...
        int plutoIndex = tabbedPane.indexOfTab("Pluto");
        var plutoPanel = new JPanel();
        plutoPanel.add(new JLabel("Pluto", icon, SwingConstants.LEADING));
        var plutoCheckBox = new JCheckBox();
        ...
        var wrapButton = new JRadioButton("Wrap tabs");
        wrapButton.addActionListener(event ->
                tabbedPane.setTabLayoutPolicy(JTabbedPane.WRAP_TAB_LAYOUT));
        buttonPanel.add(wrapButton);
        buttonGroup.add(wrapButton);
        wrapButton.setSelected(true);
        var scrollButton = new JRadioButton("Scroll tabs");
    ...
    private void loadTab(int n) {
        ...
        var planetIcon = new ImageIcon(getClass().getResource(title + ".gif"));
