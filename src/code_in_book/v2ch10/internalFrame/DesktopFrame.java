...
public class DesktopFrame extends JFrame {
    ...
    public DesktopFrame() {
        ...
        var openItem = new JMenuItem("New");
        ...
        var nextItem = new JMenuItem("Next");
        ...
        var dragOutlineItem = new JCheckBoxMenuItem("Drag Outline");
    ...
    public void createInternalFrame(Component c, String t) {
        var iframe = new JInternalFrame(t, true, // resizable
                true, // closable
                true, // maximizable
                true); // iconifiable
        ...
        iframe.addVetoableChangeListener(event ->
        {
            ...
            if ("closed".equals(name) && value.equals(true)) {
