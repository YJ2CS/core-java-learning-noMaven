...
public class FormatTestFrame extends JFrame {
    ...
    public FormatTestFrame() {
        ...
        var intField2 = new JFormattedTextField(NumberFormat.getIntegerInstance());
        ...
        var intField3 = new JFormattedTextField(new InternationalFormatter(
        ...
        var intField4 = new JFormattedTextField(NumberFormat.getIntegerInstance());
        ...
        var currencyField = new JFormattedTextField(NumberFormat.getCurrencyInstance());
        currencyField.setValue(new Double(10));
        addRow("Currency:", currencyField);
        
        var dateField = new JFormattedTextField(DateFormat.getDateInstance());
        dateField.setValue(new Date());
        addRow("Date (default):", dateField);
        
        DateFormat format = DateFormat.getDateInstance(DateFormat.SHORT);
        format.setLenient(false);
        var dateField2 = new JFormattedTextField(format);
        ...
        try {
            ...
            var urlField = new JFormattedTextField(formatter);
        ...
        var ipField = new JFormattedTextField(new IPAddressFormatter());
